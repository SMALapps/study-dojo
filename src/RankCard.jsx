...
// Small pixel-art ninja portrait — 48×48 canvas rendered at 60×60 CSS
...
// Belt icon — pixel-art white belt (SVG)
function BeltIcon() {
  return (
  ...
  return (
    <div className="rank-card">
      ...
      <div className="rank-info">
        ...
        <span className="rank-name">White Belt</span>
        <span className="rank-tier">Beginner</span>

        <div className="rank-bar-wrap">
          <div className="rank-bar-fill" style={{ width: `${pct}%` }} />
        </div>
        <span className="rank-xp">{xp} / {maxXp} XP</span>
