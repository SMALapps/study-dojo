...
export default function SessionComplete({
  ...
  return (
    <div className="screen sc-screen">
      ...
      {/* Waterfall background — same asset as Active Session */}
      ...
      {/* Ninja — sits on rock above the card */}
      <img src={ninjaImg} alt="Meditating ninja" className="as-ninja sc-ninja" />

      {/* Cream card slides up from below */}
      <div className="sc-card">
        ...
        <div className="sc-buttons">
          <button className="sc-btn sc-btn-primary" onClick={onReturnHome}>
            RETURN TO DOJO
          </button>
          <button className="sc-btn sc-btn-secondary" onClick={onStartAgain}>
